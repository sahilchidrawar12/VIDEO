...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="card">
            ...
            {!! Form::open(['route' => 'course.update', 'method' => 'post', 'enctype' => 'multipart/form-data', 'id'=>'update_course']) !!}
            <div class="card-body row">                
                <div class="col-md-05 col-sm-12 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            {!! Form::text('name',$course_data->name ? $course_data->name : app('request')->input('name'), ['class' => 'form-control']) !!}
                            @if($errors->has('name'))
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12" style="max-width:100%;flex:87.5%">
                            {!! Form::textarea('description',  $course_data->description ? $course_data->description :app('request')->input('description'), [
